...
class CoursesListPage(BasePage):
    ...
    def check_visible_course_card(
        ...
        expect(self.course_max_text.nth(index)).to_be_visible().to_have_text(f'Max score: {max_score}')

        expect(self.course_min_text.nth(index)).to_be_visible()
        expect(self.course_min_text.nth(index)).to_be_visible().to_have_text(f'Min score: {min_score}')
