...
def test_empty_courses_list():
    ...
    with sync_playwright() as playwright:
        ...
        no_resul_description_text = page.get_by_test_id('courses-list-empty-view-description-text')
        expect(no_resul_description_text).to_be_visible()
        expect(no_resul_description_text).to_have_text('Results from the load test pipeline will be displayed here')